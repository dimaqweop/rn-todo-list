...
const EAS_PROJECT_ID = "a7d47539-8773-441e-a760-be35c01f721c"; // Наприклад, "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
const PROJECT_SLUG = "todo";
const OWNER = "dimahd_dev"; // Ваш логін на expo.dev
